use crate::{
    ...
    PLAYER_RESPAWN_DELAY, TIME_STEP,
};
    ...
    if !player_state.on && (last_shot == 0. || now > last_shot + PLAYER_RESPAWN_DELAY) {
        ...
        commands
            .spawn_bundle(SpriteBundle {
                ...
                transform: Transform {
                    translation: Vec3::new(0., bottom + 75.0 / 2.0 + 15.0, 10.0),
            ...
            let mut spawn_lasers = |x_offset: f32| {
                commands
                    .spawn_bundle(SpriteBundle {
                        ...
                        transform: Transform {
                            translation: Vec3::new(x + x_offset, y + 5.0, 0.),
...
fn laser_movement(
    ...
    for (laser, speed, mut laser_tf, _) in query.iter_mut() {
