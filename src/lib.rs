...
const PLAYER_SPRITE: &str = "11B.png";
const ENEMY_SPRITE: &str = "2B.png";
const PLAYER_LASER_SPRITE: &str = "lasers/01.png";
const ENEMY_LASER_SPRITE: &str = "lasers/02.png";
const EXPLOSION_SHEET: &str = "explosion_01_strip13.png";
...
fn setup(
    ...
    let texture_atlas = TextureAtlas::from_grid(texture_handle, Vec2::new(2548., 190.), 13, 1);
...
fn player_laser_hit_enemy(
    ...
    let mut enemies_blasted = HashSet::new();
